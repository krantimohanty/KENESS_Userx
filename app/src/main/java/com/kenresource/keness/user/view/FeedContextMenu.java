package com.kenresource.keness.user.view;

import android.content.Context;
import android.view.ViewGroup;
import android.widget.LinearLayout;

import com.kenresource.keness.user.Adapter.Utils;
...
//    private void init() {
//        LayoutInflater.from(getContext()).inflate(com.example.suchismita.essappleave.R.layout.view_context_menu, this, true);
...
//    }
//
//    @OnClick(com.example.suchismita.essappleave.R.id.btnSharePhoto)
